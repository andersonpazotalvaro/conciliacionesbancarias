package co.smart.procesador.tucompraapp.importarcsv;
...
@Component
public class CsvImportApp {

    private final Path root = Paths.get("uploads/");

    /*public List<DtoTuCompraApp> importarCSV(File file) throws IOException {
        List<DtoTuCompraApp> tuCompraApps = new ArrayList<DtoTuCompraApp>();
    ...
    try {
        ...
        CSVReader leerTuCompraApp = new CSVReaderBuilder(fileReader).withCSVParser(csvParser).build();
        ...
        while ((nextRecord = reader.readNext()) != null) {
            ...
            tuCompraApps.add(new DtoTuCompraApp(
    ...
    public List<DtoTuCompraApp> importarCSV2(File file) throws IOException {
        List<DtoTuCompraApp> tuCompraApps = new ArrayList<DtoTuCompraApp>();
        ...
        try {
            ...
            while ((nextRecor = br.readLine()) != null) {
                ...
                String nombre_comprador = nextRecord[17];
                String apellidos_comprador = nextRecord[18];
                //System.out.println(apellidos_comprador);
                String documento_comprador = nextRecord[19];
                String telefono_comprador = nextRecord[20];
                String direccion_comprador = nextRecord[21];
                String ip_comprador = nextRecord[22];
